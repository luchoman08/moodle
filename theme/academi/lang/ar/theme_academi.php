...
<h3>قروض موضوع</h3>
<p>
<h3>Moodle Academi موضوع</h3>
<p>
ويستند هذا الموضوع على موضوع Bootstrapbase موودل.
</p>
<p>
...
$string['logodesc'] = 'يرجى تحميل شعار مخصص هنا إذا كنت ترغب في إضافته إلى الرأس
                       <br>يجب أن تكون الصورة 37px عالية وأي عرض معقول (الحد الأدنى: 250px) أن الدعاوى.';
 ...
 <div class="embed-responsive embed-responsive-16by9">
  <iframe src="https://www.youtube.com/embed/fNE7pyDyw3Y" allowfullscreen="" frameborder="0" height="391" width="545"></iframe>
        	...
        	<div class="col-lg-6 col-md-6 col-sm-6">
              ...
              <p>أبجد هوز هو مجرد دمية النص من صناعة المطابع ودور النشر. وكان أبجد هوز النص القياسي في هذه الصناعة وهمية من أي وقت مضى منذ 1500s، عندما مجهول مقعدا الطابعة الطباعة من نوع وسارعت الى تقديم نوع العينة الكتاب. وقد نجا خمسة قرون فحسب، بل أيضا قفزة في التنضيد الالكتروني، وصحائف taining أبجد هوز الممرات، ومؤخرا في التنضيد الالكتروني، وصحائف taining أبجد هوز الممرات، وأكثر من ذلك recentwith برامج النشر المكتبي مثل PageMaker ألدوس بما في ذلك إصدارات أبجد هوز.</p>
              <div class="readmore-btn"><a href="#">اقرأ أكثر</a></div>
            </div>
          </div>
        </div>';
...
$string['sb2_default_cnt'] = '<p>أبجد هوز هو مجرد دمية النص من <br class="visible-lg">صناعة الطباعة والتنضيد
.</p>';
$string['sb2_default_title'] = 'تصبح مدرس';
$string['sb3_default_cnt'] = '<p>أبجد هوز هو مجرد دمية النص من <br class="visible-lg">صناعة الطباعة والتنضيد
.</p>';
