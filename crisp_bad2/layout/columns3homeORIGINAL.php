...
<li>
                                                                        <div>
                                                                                <a href="http://dintev.univalle.edu.co/2-uncategorised/58-memorias-encuentro" target="_blank"><img src="<?php echo $CFG->wwwroot.'/theme/'.$CFG->theme.'/img/N-Encuentro30Nov.png'; ?>" alt=""/></a>
 ...
 <li>
                                                                        <div>
                                                                                <a href="http://dintev.univalle.edu.co/2-uncategorised/55-de-videoconferencias-y-tortugas" target="_blank"><img src="<?php echo $CFG->wwwroot.'/theme/'.$CFG->theme.'/img/N-VCIbiologia.jpg'; ?>" alt=""/></a>
 ...
 <li>
                                                                        <div>
                                                                                <a href="http://dintev.univalle.edu.co/10-boletin/57-invitacion-encuentro" target="_blank"><img src="<?php echo $CFG->wwwroot.'/theme/'.$CFG->theme.'/img/N-MeryCruz.jpg'; ?>" alt=""/></a>
	                            ...
	                            -->
	                                <li>
	                                	<div>
	                                       <a href="<?php echo $CFG->wwwroot.'/info-dintev/CVUV_usuarios_2017.html'; ?>" target="_blank"><img src="<?php echo $CFG->wwwroot.'/theme/'.$CFG->theme.'/img/campus2.png'; ?>" alt=""/></a>
										</div>
									</li>
									<!--
									<li>
...
<li>
	...
	<!-- 	<li>
                                                                        <div>
                                                                                <a href="http://dintev.univalle.edu.co/2-uncategorised/65-convocatoria-dintev/" target="_blank"><img src="<?php echo $CFG->wwwroot.'/theme/'.$CFG->theme.'/img/convocatoria_Vigia_Marzo21.png'; ?>" alt=""/></a>
