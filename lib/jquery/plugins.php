...
/*
global $CFG;
if(!isset($CFG->jqueryVersion)){
	$jqueryVersion = 'jquery-3.1.0.min.js';
}
else{
	$jqueryVersion = $CFG->jqueryVersion;
}

if(!isset($CFG->jUIversion)){
	$jUIversion = 'ui-1.12.1';
}
else{
	$jUIversion = $CFG->jUIversion;
}*/
...
$plugins = array(
    'jquery'  => array('files' => array($jqueryVersion)),
    'ui'      => array('files' => array($jUIversion.'/jquery-ui.min.js')),
    'ui-css'  => array('files' => array($jUIversion.'/theme/smoothness/jquery-ui.min.css')),
);
