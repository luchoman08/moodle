...
$userform->display();
echo "<script>document.getElementById('id_institution').value='Universidad del Valle'; </script>";echo "<script>document.getElementById('id_institution').value='Universidad del Valle'; </script>";
// And proper footer.
echo $OUTPUT->footer();
