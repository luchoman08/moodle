...
function useredit_shared_definition(&$mform, $editoroptions, $filemanageroptions, $user) {
    ...
    $mform->addElement('header', 'moodle_optional', get_string('optional', 'form'), 'onload = "alert(\'holamundo\');"');
    ...
    $mform->addElement('text', 'department', get_string('department'), 'maxlength="255" size="25" onclick = "document.getElementById(\'id_institution\').value=\'Universidad del Valle\';"  ');
