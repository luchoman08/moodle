...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('text','fullname', get_string('fullnamecourse'),'maxlength="254" size="90" style="width:487px"');
        ...
        $mform->addElement('text', 'shortname', get_string('shortnamecourse'), 'maxlength="130" size="200" style="width:487px"');
        ...
        $mform->addElement('text','idnumber', get_string('idnumbercourse'),'maxlength="100"  size="200" style="width:487px"');
