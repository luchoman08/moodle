...
$CFG->dbhost    = '192.168.247.126';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'moodle';     // database name, eg moodle
$CFG->dbuser    = 'moodle';   // your database username
$CFG->dbpass    = 'tekacut8';   // your database password
...
$CFG->wwwroot='https://campusvirtual.univalle.edu.co/moodle';
//=========================================================================
...
$CFG->dataroot  = '/vhosts/campus/moodledata';
...
//      $CFG->defaultblocks_override = 'participants,activity_modules,search_forums,course_list:news_items,calendar_upcoming,recent_activity';
        $CFG->defaultblocks_override = ':messages,participants,messageteacher,recent_activity,news_items,activity_modules,search_forums';
//
...
//=========================================================================
// 10. CONFIGURACION INTERFAZ REGISTRO - CAMPUS
//=========================================================================

$CFG->dirroot   = '/vhosts/campus/public_html/moodle';
$CFG->wwwrootinterface = 'https://campusvirtual.univalle.edu.co/InterfazRegistroACampus';
...
//plugin despliegue de los cursos
$plugin->component = 'format_weeksrev';
//
